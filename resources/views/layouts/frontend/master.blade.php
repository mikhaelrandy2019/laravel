...
<header class="header">
    ...
    <a href="#" class="logo">
        <img src="assets/images/NSG logo.png" alt="">
    </a>
...
<section class="footer">
    ...
    <div class="credit">Copyright © 2022, Nice Gaming Shop | All Rights Reserved.</div>
